...
<<<<<<< 9a864a514d48d74d3b323a440ce2a9d2370eff0a:svgpathtools/svg_to_paths.py
...
>>>>>>> adding transforms to import:svgpathtools/svg2paths.py
...
def polyline2pathd(polyline_d, is_polygon=False, transform=None):
...
def polygon2pathd(polyline_d, transform=None):
    """converts the string from a polygon points-attribute to a string 
    for a Path object d-attribute.
    Note:  For a polygon made from n points, the resulting path will be
    composed of n lines (even if some of these lines have length zero).
    """
    return polyline2pathd(polyline_d, True, transform)
